...
class ApiGatewayImpl implements ApiGateway {
  ...
  Future<AccessTokenModel> checkAccessTokenStatus() async {
    try {
      ...
      final graphResponse = await _dioClient.get(
          '${Constants.facebookBaseURL}debug?input_token=$token&access_token=$token');
  ...
  //   try {
  //     final response =
  //         await _dioClient.get(Constants.rasoocProdUrl + Constants.location);
  ...
  Future<List<CategoryModel>> getCampaginCategoires() async {
    try {
      ...
      final response = await _dioClient
          .get(Constants.rasoocProdUrl + Constants.campaignCategories);
      final json = _dioClient.getJsonBody(response);
  ...
  Future<AccountResponseModel> createUserAccount(ProfileModel model) async {
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.createAccount,
        data: data,
      );
      final json = _dioClient.getJsonBody(response);
      if (json["error"] != null) {
  ...
  Future<ProfileModel> getUserProfile() async {
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.getProfile,
        options: Options(
          headers: {
  ...
  Future<List<CampaignShortModel>> getCampaigns(
    ...
    try {
      ...
      final response = await _dioClient.post(
          Constants.rasoocProdUrl + Constants.getCampagins,
          data: data,
          options: Options(
            headers: headers,
          ));
  ...
  Future<CampaignDetailModel> getCampaignDetail(int campaignId) async {
    try {
      ...
      final response = await _dioClient.post(
          Constants.rasoocProdUrl + Constants.getCampaignDetail,
          data: data,
          options: Options(
            headers: headers,
          ));
  ...
  Future<List<CampaignShortModel>> searchCampaigns(String query) async {
    try {
      ...
      final response = await _dioClient.post(
          Constants.rasoocProdUrl + Constants.searchCampaign,
          data: data,
          options: Options(
            headers: headers,
          ));
  ...
  Future<ProfileModel> checkUserExistUsingFBID(
    ...
    try {
      ...
      final pref = GetIt.instance<SharedPreferenceHelper>();
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.checkUserExistFBID,
        data: data,
      );
      final json = _dioClient.getJsonBody(response);
      if (json['data'] != null && json['data'].isNotEmpty) {
  ...
  Future<CampaignShortModel> favoriteCampgain(
    ...
    try {
      ...
      final response =
          await _dioClient.post(Constants.rasoocProdUrl + Constants.favCampagin,
              data: data,
              options: Options(
                headers: headers,
              ));
  ...
  Future<ProfileModel> updateUserProfile(ProfileModel model) async {
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.updateProfile,
        data: data,
        ...
        case FacebookLoginStatus.success:
          ...
          if (_listOfPages.isNotEmpty) {
            ...
            final resp = await _dioClient.post(
              Constants.rasoocProdUrl + Constants.linkFBAccounts,
              data: data,
              options: Options(headers: headers),
            );
      ...
      switch (facebookLoginResult.status) {
        ...
        case FacebookLoginStatus.success:
          ...
          if (instaLinlResponse.pageId != null) {
            ...
            final resp = await _dioClient.post(
              Constants.rasoocProdUrl + Constants.linkInstaAccount,
              data: data,
              options: Options(headers: headers),
            );
            final jsonResp = _dioClient.getJsonBody(resp);
    ...
    try {
      ...
      switch (result.status) {
        case TwitterLoginStatus.loggedIn:
          ...
          final resp = await _dioClient.post(
            Constants.rasoocProdUrl + Constants.linkTwitterAccount,
            data: data.toJson(),
            options: Options(headers: headers),
          );
          final jsonResp = _dioClient.getJsonBody(resp);
          if (jsonResp["data"] != null && jsonResp["data"].isNotEmpty) {
            final twitterAccount = TwitterAccount.fromJson(jsonResp["data"][0]);
  ...
  Future<SocialAccountsModel> getConnectedAccounts() async {
    try {
      ...
      final response = await _dioClient.get(
        Constants.rasoocProdUrl + Constants.getConnectedAccounts,
        options: Options(headers: headers),
      );
  ...
  Future<SocialAccountsModel> removeConnectedAccount(
    ...
    try {
      ...
      final response = await _dioClient.post(
          Constants.rasoocProdUrl + Constants.removedConnectedAccount,
          data: data,
          options: Options(
            headers: headers,
          ));
  ...
  Future<bool> submitSubmission(
    ...
    try {
      ...
      for (final file in files) {
        ...
        if (file is Asset) {
          ...
          final uploadRes = await _dioClient.post(
              Constants.rasoocProdUrl + Constants.uploadImage,
              options: Options(
                headers: headers,
              ),
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.submitSubmission,
        options: Options(
          headers: headers,
        ),
        data: data,
  ...
  Future<List<PostSubmissionsModel>> getSubmissionList(
    ...
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.getSubmissionsListDetails,
        options: Options(headers: headers),
        data: data,
      );
  ...
  Future<bool> withdrawSubmission(int id) async {
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.withdrawSubmission,
        options: Options(headers: headers),
        data: data,
      );
  ...
  Future<bool> publishSingleMedia(PostSubmissionsModel submissionsModel) async {
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.publishPostToInstagram,
        options: Options(headers: headers),
        data: data,
      );
  ...
  Future<List<ContentRightsModel>> getContentRights(
    ...
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.getContentRights,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  Future<ContentRightsModel> contentRightDecision(
    ...
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.contentRightDecision,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  Future<List<ContentCampaignsModel>> getContentCampaign(
    ...
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.getContentCampaigns,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  Future<ContentCampaignsModel> contentCampaignDecision(
    ...
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.contentCampaignDecision,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  Future<List<ChatModel>> postComment(int submissionId, String message) async {
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.sendComment,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  Future<List<ChatModel>> getSubmissionComments(int submissionId) async {
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.getSubmissionChat,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  Future<List<ChatModel>> getInfluencerChats() async {
    try {
      ...
      final response = await _dioClient.get(
        Constants.rasoocProdUrl + Constants.getInfluencerChats,
        options: Options(headers: headers),
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  Future<List<ChatModel>> sendInfluencerChat(String message) async {
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.sendInfluencerChat,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  Future<List<NotificationsModel>> getNotifications() async {
    try {
      ...
      final response = await _dioClient.get(
        Constants.rasoocProdUrl + Constants.getNotifications,
        options: Options(headers: headers),
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  Future<bool> publishToTwitter(
    ...
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.publishToTwtitter,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  Future<PostSubmissionsModel> getSubmissionDetail(int submissionId) async {
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.getSingleSubmissionDetail,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  Future<bool> clearNotification(NotificationDecision decision, int id) async {
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.clearNotifications,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  Future<bool> publishStoryAndCarousel(
    ...
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.submitUrl,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  Future<bool> applyToCampaign(
    ...
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.applyCampaign,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  Future<List<CampaignShortModel>> getInfluencerCampaigns(CampaignStatus status,
    ...
    try {
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.getInfluencerCampaigns,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  @override
  Future<bool> withdrawInfluencerCampaign(
    int campaignId,
  ) async {
    try {
      final pref = GetIt.instance<SharedPreferenceHelper>();
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrl + Constants.withdrawInfluencerCampaigns,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  Future<bool> goDaddyWhitelistIp() async {
    ...
    // try {
    //   final response = await _dioClient.get(
    //     "${Constants.goDaddyWhitelistUrl}api?k=${Secrets.goDaddyApiKey}&s=${Secrets.goDaddyApiSecretKey}&a=allowlist",
    //   );
    //   final jsonResonse = response.statusMessage;

    //   if (jsonResonse != null && jsonResonse.contains("OK")) {
    //     return true;
    //   } else {
    //     if (jsonResonse != null && jsonResonse.contains("allowed")) {
    //       return true;
    //     }
    //     return false;
    //   }
  ...
  @override
  Future<List<GeographicEntity>> getCities(int stateId) async {
    try {
      final List<GeographicEntity> list = <GeographicEntity>[];
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrlNoHttps + Constants.getCities,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
      ...
      if (jsonResonse["data"] != null && jsonResonse["data"].isNotEmpty) {
        for (final json in jsonResonse["data"]) {
          list.add(GeographicEntity.fromJson(json));
        }
      }
  ...
  @override
  Future<List<GeographicEntity>> getCountries() async {
    try {
      final List<GeographicEntity> list = <GeographicEntity>[];
      ...
      final response = await _dioClient.get(
        Constants.rasoocProdUrlNoHttps + Constants.getCountries,
        options: Options(headers: headers),
      );
      final jsonResonse = _dioClient.getJsonBody(response);
  ...
  @override
  Future<List<GeographicEntity>> getStates(int countryId) async {
    try {
      final List<GeographicEntity> list = <GeographicEntity>[];
      ...
      final response = await _dioClient.post(
        Constants.rasoocProdUrlNoHttps + Constants.getStates,
        options: Options(headers: headers),
        data: data,
      );
      final jsonResonse = _dioClient.getJsonBody(response);
