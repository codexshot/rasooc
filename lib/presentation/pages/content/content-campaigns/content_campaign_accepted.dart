...
class ContentCampaignAccepted extends StatefulWidget {
  @override
  _ContentCampaignAcceptedState createState() =>
      _ContentCampaignAcceptedState();
}

class _ContentCampaignAcceptedState extends State<ContentCampaignAccepted> {
  @override
  void initState() {
    super.initState();
    intitalize();
  ...
  Future<void> intitalize() async {
    ...
    await state.getContentCampaigns(ContentStatus.approved);
            ...
            : state.listOfContentCampaigns.isNotEmpty
                ...
                : Center(
                    child: RNoDataContainer(
                      headingTitle: "No Accepted content campaigns",
                      subHeading:
                          "Your accepted content campaigns will be here.",
                    ),
                  ),
      ),
    );
