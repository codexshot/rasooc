...
class ContentCampaignSold extends StatefulWidget {
  @override
  _ContentCampaignSoldState createState() => _ContentCampaignSoldState();
}

class _ContentCampaignSoldState extends State<ContentCampaignSold> {
  @override
  void initState() {
    super.initState();
    intitalize();
  ...
  Future<void> intitalize() async {
    ...
    await state.getContentCampaigns(ContentStatus.sold);
            ...
            : state.listOfContentCampaigns.isNotEmpty
                ...
                : Center(
                    child: RNoDataContainer(
                      headingTitle: "No Sold content campaigns",
                      subHeading: "Your sold content campaigns will be here.",
                    ),
                  ),
      ),
    );
