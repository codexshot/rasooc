...
class ContentRightDeclined extends StatefulWidget {
  @override
  _ContentRightDeclinedState createState() => _ContentRightDeclinedState();
}

class _ContentRightDeclinedState extends State<ContentRightDeclined> {
  @override
  void initState() {
    super.initState();
    intitalize();
  ...
  Future<void> intitalize() async {
    ...
    await state.getContentRights(ContentStatus.declined);
            ...
            : state.listOfContentRights.isNotEmpty
                ...
                : Center(
                    child: RNoDataContainer(
                      headingTitle: "No Declined content rights",
                      subHeading: "Your declined content will be here.",
                    ),
                  ),
      ),
    );
