...
class ContentRightAccepted extends StatefulWidget {
  @override
  _ContentRightAcceptedState createState() => _ContentRightAcceptedState();
}

class _ContentRightAcceptedState extends State<ContentRightAccepted> {
  @override
  void initState() {
    super.initState();
    intitalize();
  ...
  Future<void> intitalize() async {
    ...
    await state.getContentRights(ContentStatus.approved);
            ...
            : state.listOfContentRights.isNotEmpty
                ...
                : Center(
                    child: RNoDataContainer(
                      headingTitle: "No Accepted content rights",
                      subHeading: "Your accepted content will be here.",
                    ),
                  ),
      ),
    );
